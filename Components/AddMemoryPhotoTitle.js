        ...
        <Pressable onPress={pickPhoto} style={styles.photoBox}>
          {photoUri ? (
            ...
            <View style={styles.photoPlaceholder}>
              <Image source={require('../assets/add_photo_icon.webp')} style={{ width: 40, height: 40, tintColor: '#111' }} />
              <Text style={{ marginTop: 8, fontSize: 18, color: '#111' }}>Add photo</Text>
            </View>
          )}
        </Pressable>
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 22, fontWeight: '800', color: '#FFFFFF', textShadowColor: '#B02B2B', textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 6 },
  ...
  dotActive: { 
    ...
    backgroundColor: '#FF6B35' // Оранжево-красный активный
  },
  ...
  inputWrap: {
    ...
    borderWidth: 2,
    borderColor: '#FF6B35', // Оранжевая рамка
  },
  input: { height: 56, fontSize: 20, color: '#FFFFFF' }, // Белый текст
