...
import {
  ...
  Pressable, FlatList, Share, Dimensions, ScrollView,
  TextInput, Platform
} from 'react-native';
              ...
              <Pressable onPress={pickPhoto} style={styles.photoBox}>
                {photoUri ? (
                  ...
                  <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                    <Text style={{ fontSize: 18, color: '#FF8A35', textShadowColor: '#FF3B2E', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2 }}>Add photo</Text>
                  </View>
                )}
              </Pressable>
...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 30, fontWeight: '900', color: '#FFFFFF', textShadowColor: '#FF0000', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2 },

  monthRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 24, marginTop: 8 },
  monthTitle: { fontSize: 30, fontWeight: '800', color: '#FF8A35', textShadowColor: '#FF3B2E', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2 },
  monthArrow: { padding: 8 },
  monthArrowImg: { width: 32, height: 32, tintColor: '#FF6B35' },
  ...
  cellEmpty: { opacity: 0 },
  cellHas: { backgroundColor: '#D23A36' },
  cellActive: { borderWidth: 3, borderColor: '#FFFFFF' },
  cellText: { fontSize: 18, fontWeight: '700', color: '#111' },
  ...
  emptyText: { fontSize: 22, fontWeight: '900', textAlign: 'center', color: '#FFFFFF', textShadowColor: '#FF3B2E', textShadowOffset: { width: 2, height: 2 }, textShadowRadius: 4 },

  /* preview card */
  preview: {
    borderRadius: 22, paddingBottom: 10,
    backgroundColor: 'rgba(255, 140, 53, 0.3)',
  ...
  previewTitle: { fontSize: 24, fontWeight: '900', color: '#fff', marginTop: 6, marginHorizontal: 10, textShadowColor: '#B82D2D', textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 6 },
  previewDate: { marginTop: 8, marginHorizontal: 12, fontSize: 16, color: '#FF8A35', textShadowColor: '#FF3B2E', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2, fontWeight: '700' },
  previewDesc: { marginTop: 6, marginHorizontal: 12, fontSize: 16, color: '#FF8A35', textShadowColor: '#FF3B2E', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2 },
  moreBtn: { position: 'absolute', right: 12, bottom: 8, padding: 6 },
  moreText: { fontSize: 22, fontWeight: '900', color: '#fff', textShadowColor: '#B82D2D', textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 6 },
  ...
  cardTitle: { fontSize: 28, fontWeight: '900', color: '#fff', marginTop: 8, marginHorizontal: 12, textShadowColor: '#B82D2D', textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 6 },
  cardDate: { marginTop: 12, marginHorizontal: 12, fontSize: 16, color: '#FF8A35', textShadowColor: '#FF3B2E', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2, fontWeight: '700' },
  cardDesc: { marginTop: 10, marginHorizontal: 12, fontSize: 16, color: '#FF8A35', textShadowColor: '#FF3B2E', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2 },
  actions: { marginTop: 18, flexDirection: 'row', justifyContent: 'space-around', paddingHorizontal: 10, marginBottom: 8 },
  actionText: { fontSize: 28, fontWeight: '900', color: '#fff', textShadowColor: '#B02B2B', textShadowOffset: { width: 0, height: 2 }, textShadowRadius: 6 },
  ...
  photoBox: {
    ...
    borderRadius: 18, borderWidth: 3, borderColor: '#FF6B35',
  ...
  input: {height: 56, fontSize: 20, color: '#FF8A35', textShadowColor: '#FF3B2E', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2 },
  ...
  dateText: { fontSize: 20, color: '#FFFFFF', fontWeight: '700' },

  calendarContainer: {
    marginTop: 16, marginHorizontal: 16, backgroundColor: 'rgba(255,255,255,0.95)',
    borderRadius: 16, padding: 12, borderWidth: 2, borderColor: '#FF6B35',
  ...
  textAreaWrap: { width:350,
    ...
    borderRadius: 22, backgroundColor: 'rgba(255,140,53,0.3)',
    borderWidth: 3, borderColor: '#FF6B35'
  },
  textArea: { minHeight: 180, padding: 14, fontSize: 18, color: '#FF8A35', textShadowColor: '#FF3B2E', textShadowOffset: { width: 1, height: 1 }, textShadowRadius: 2 },
